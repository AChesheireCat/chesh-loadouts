...
// Rifle
#define RIFLE "CUP_arifle_M16A1E1"
#define RIFLE_MAG "30Rnd_556x45_Stanag_Tracer_Red:7","30Rnd_556x45_Stanag_Tracer_Red:3"
...
#define GLRIFLE_MAG_HE "vn_40mm_m651_cs_mag:5"
#define GLRIFLE_MAG_SHOT "vn_40mm_m576_buck_mag:5"
#define GLRIFLE_MAG_FLARE "UGL_FlareYellow_F:4"
// Carbine
#define CARBINE "vn_m1897"
#define CARBINE_MAG "vn_m1897_fl_mag:25"
// AR
#define AR "CUP_hgun_BallisticShield_Armed_M9"
#define AR_MAG "CUP_15Rnd_9x19_M9:10"
// AT
#define AT 
#define AT_MAG 
// MMG
...
#define SPOTTER_OPTIC "CUP_acc_Flashlight_MP5"
// SMG
#define SMG "CUP_smg_MP5A5"
#define SMG_MAG "CUP_30Rnd_9x19_MP5:5"
// Pistol
#define PISTOL "CUP_hgun_M9"
#define PISTOL_MAG "CUP_15Rnd_9x19_M9:4"
#define PISTOL_OPTIC 
// Grenades
#define SPEC_GRENADES "ACE_CTS9:4","SmokeShell:2"
#define LEADER_GRENADES "ACE_CTS9:4","vn_m7_grenade_mag:1",LEADER_SMOKES,SIDE_CHEM_LIGHT
// Gear
#define TOOLS BASE_TOOLS,"ACE_SpraypaintGreen"
...
class rifleman {// rifleman
  ...
  weapons[] = {RIFLE};
  magazines[] = {RIFLE_MAG,SPEC_GRENADES};
  items[] = {TOOLS};
  linkedItems[] = {LINKED};
...
class ftl: rifleman {// FTL
  ...
  backpack[] = {FTLPACK};
  weapons[] = {GLRIFLE};
  magazines[] = {GLRIFLE_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,GLRIFLE_MAG_SHOT,LEADER_GRENADES};
  items[] += {LEADER_TOOLS};
...
class aar: rifleman {// AAR
  backpack[] = {ARPACK};
  backpackItems[] += {"AMP_Breaching_Charge_Mag:4","ACE_Clacker"};
  linkedItems[] += {BINOS};
};
