...
// Rifle
#define RIFLE "CUP_arifle_AK19_black","CUP_arifle_AK19_VG_black","CUP_arifle_AK19_AFG_black"
...
#define AT_OPTIC "CUP_optic_PGO7V3"
...
class Fic_eng: vicd {
  backpack[] = {"acp_A2_CDF_lite_B_Carryall_A2_CDF"};
  items[] += {BASE_ENG};
  backpackItems[] = {};
};
