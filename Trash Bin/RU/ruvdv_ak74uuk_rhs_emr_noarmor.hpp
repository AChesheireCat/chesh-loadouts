...
// Camo set
#define CAMO_UNIFORM "rhs_uniform_6sh122_v2"
#define CAMO_VEST "rhs_6sh117_rifleman"
#define CAMO_BACKPACK "B_Battle_Belt_F"
#define CAMO_HEADGEAR "rhs_6b47_6B50"
// Rifle
#define RIFLE "rhs_weap_ak74mr"
#define RIFLE_MAG "potato_magazine_545x39_30rnd_reload_tracer_Green:10"
#define RIFLE_ATTACHMENTS "rhs_acc_dtk", "rhs_acc_perst3_top", "rhs_acc_1p87"
#define AAR_ATTACHMENTS RIFLE_ATTACHMENTS
#define ALT_OPTICS "rhs_acc_rakurspm","cup_optic_eotech553_black","rhs_acc_okp7_picatinny"
// GL Rifle
...
#define AR_VEST "rhs_6sh117_ar"
#define MMG_VEST "rhs_6sh117_mg"
...
#define CARRYALL "CUP_O_RUS_Patrol_bag_Summer","CUP_O_RUS_Patrol_bag_Summer","CUP_O_RUS_Patrol_bag_Summer_Shovel"
...
class mtrg: Fic_Soldier_Carbine {// Mortar Gunner
  ...
  MORTAR_GEAR("ace_compat_rhs_afrf3_2b14_carry")
  magazines[] += {"ACE_1Rnd_82mm_Mo_HE:6"};
};
class mtrag: Fic_Spotter {// Assistant Mortar
  backpack[] = {"rhs_tortila_khaki"};
  MORTAR_GEAR("ace_csw_carryMortarBaseplate")
...
class vicc: Fic_Soldier_Carbine {// Crew
  uniform[] = {"rhs_uniform_vkpo","rhs_uniform_vkpo_gloves"};
  backpack[] = {"B_Battle_Belt_XL_F"};
  vest[] = {"rhs_6b45_holster","rhs_6b45_holster","rhs_6b45_light"};
  headgear[] = {"rhs_6b48"};
  handguns[] = {PISTOL};
