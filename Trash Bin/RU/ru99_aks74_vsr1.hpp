...
// Camo set
#define CAMO_UNIFORM "rhs_uniform_afghanka_vsr_1","rhs_uniform_afghanka_vsr_2"
...
#define FTL_VEST "rhs_6b5_officer_khaki"
#define SL_VEST "rhs_6b5_officer_khaki"
#define AR_VEST CAMO_VEST
#define M_VEST "rhs_6b5_medic_khaki"
//HMG
...
class vicc: Fic_Soldier_Carbine {// Crew
  uniform[] = {"rhs_uniform_afghanka_grey"};
  backpack[] = {"B_Battle_Belt_XL_F"};
  vest[] = {"rhs_vest_commander"};
  headgear[] = {"rhs_tsh4"};
  weapons[] = {SMG};
