...
description = "Fictional Revolutionaries c. 1915 (Last Updated: 2025/06/25)";
...
// Camo set
#define CAMO_UNIFORM "vn_b_uniform_aus_01_01","vn_b_uniform_aus_02_01"
#define CAMO_VEST "gm_ge_army_vest_80_rifleman"
#define CAMO_BACKPACK "B_Battle_Belt_F"
#define CARRYALL "B_Battle_Belt_XL_F"
#define CAMO_HEADGEAR "gm_dk_headgear_m52_oli"
#define CAMO_HEADGEAR_SPECIAL "gm_ge_headgear_sidecap_80_oli"
// Pilot Camo set
...
// Rifle
#define RIFLE "vn_m1903"
#define RIFLE_MAG "vn_m1903_t_mag:10"
#define RIFLE_ATTACHMENTS "vn_b_m1903"
...
// AR
#define AR "vn_m14a1"
#define AR_MAG "vn_m14_t_mag:10"
#define AR_ATTACHMENTS "vn_m14a1"
// AT
#define AT 
#define AT_MAG 
// MMG
...
// SMG
#define SMG "vn_f1_smg"
#define SMG_MAG "vn_f1_smg_t_mag:6"
// Pistol
#define PISTOL "vn_m712"
#define PISTOL_MAG "vn_m712_mag:5"
#define PISTOL_ATTACHMENTS 
// Melee
#define MELEE "Axe","WBK_SmallHammer","WBK_ww1_Club","WBK_survival_weapon_3","WBK_BrassKnuckles"
// Grenades
#define LEADER_GRENADES SIDE_FRAG,LEADER_SMOKES
#define SIDE_FRAG "vn_t67_grenade_mag:4"
//#define OFF_FRAG ":2"
//#define DEF_FRAG ":2"
#define LOADOUT_GRENADES SIDE_FRAG,BASE_SMOKES
// Gear
#define TOOLS ETOOL
#define LEADER_TOOLS RADIO_SR,SIDE_KEY
...
#define CAMO_VEST_SL "gm_ge_army_vest_80_leader_smg"
...
#define DEMO "SatchelCharge_Remote_Mag"
#define DEMOTOOL 
...
class ar: rifleman {// AR
  ...
  weapons[] = {AR};
  magazines[] = {AR_MAG,LOADOUT_GRENADES};
  handguns[] = {MELEE};
};
...
class sm: Fic_Soldier_Carbine {// Medic - remove MR
  vest[] = {CAMO_VEST_MEDIC};
  magazines[] = {CARBINE_MAG,MEDIC_GRENADES};
  backpack[] = {CAMO_BACKPACK_MEDIC};
  items[] += {"WBK_HeadLampItem"};
  backpackItems[] = {"ACE_elasticBandage:25","ACE_packingBandage:15","ACE_epinephrine:10","ACE_salineIV:4","ACE_salineIV_500:6","ACE_salineIV_250:8","ACE_morphine:10","ACE_tourniquet:6","ACE_splint:12","ACE_adenosine:5","potato_naloxone:5","ACE_painkillers"};
};
...
class rifleman_02: rifleman {// Rifleman 2 - SMG Gunner
  vest[] = {"gm_ge_army_vest_80_rifleman_smg"};
  weapons[] = {SMG};
  handguns[] = {MELEE};
  magazines[] = {SMG_MAG,LOADOUT_GRENADES};
};
