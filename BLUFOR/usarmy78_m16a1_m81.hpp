...
description = "US Army c.1978 - MAT is the ACE M47 Dragon. SF section fully configured as Army SF (Green Berets). Uses S.O.G Prarie Fire assets.";
...
// Camo set
#define CAMO_UNIFORM "cwr3_b_uniform_m81_woodland","cwr3_b_uniform_m81_woodland_gloves","cwr3_b_uniform_m81_woodland_rolled_gloves"
...
// SF Classes - recreating Delta Force just before the Invasion of Panama

#define SF_UNIFORM "cwr3_b_uniform_og107_rolled_gloves"
...
#define SF_VEST_SNIPER "cwr3_b_vest_tgfaust_black"
#define SF_HEADGEAR "cwr3_i_headgear_cap_og107","cwr3_b_headgear_boonie_og107"
...
class sf_sl: sf_ftl {// SL
  ...
  linkedItems[] = {LINKED,LEADER_LINKED,"vn_anpvs2_binoc"};
  items[] += {RADIO_MR};
  secondaryAttachments[] = {SF_PISTOL_ATTACHMENTS};
};
