...
description = "Counter-Strike: Global Offensive - Phoenix Connexion";
...
// Camo set
#define CAMO_UNIFORM "U_C_Uniform_Scientist_01_formal_F","U_C_Uniform_Scientist_01_formal_F","U_BG_Guerilla2_1","U_C_Uniform_Scientist_01_F"
#define CAMO_VEST "V_DeckCrew_white_F"
#define CAMO_BACKPACK "B_Battle_Belt_XL_F"
#define CARRYALL "rhs_tortila_grey"
...
#define CAMO_HEADGEAR_PILOT "CUP_H_PMC_EP_Headset"
// Vic Crew Camo set
...
#define RIFLE_MAG "hlc_30Rnd_762x39_m_ak:10"
#define RIFLE_MAG_REDUCED "hlc_30Rnd_762x39_m_ak:5"
#define RIFLE_ATTACHMENTS "potato_strongerFlashlights_CUP_LED_flashlight"
#define AAR_ATTACHMENTS RIFLE_ATTACHMENTS
#define ALT_OPTICS 
// GL Rifle
#define GLRIFLE "CUP_arifle_AKM_GL_Early"
...
#define AR_MAG "CUP_200Rnd_TE4_Green_Tracer_556x45_M249:2"
// AT
...
#define SNIPER_OPTIC "ptv_PMII", "CUP_bipod_Harris_1A2_L_BLK"
// Spotter
...
#define SMG_MAG "CUP_64Rnd_Green_Tracer_9x19_Bizon_M:3"
// Pistol
#define PISTOL "CUP_hgun_TEC9"
#define PISTOL_MAG "CUP_32Rnd_9x19_TEC9:3"
#define PISTOL_OPTIC 
// Pistol 2
#define PISTOL2 "CUP_hgun_Glock17_tan"
#define PISTOL2_MAG "CUP_17Rnd_9x19_glock17:5"
// Pistol 3
#define PISTOL3 "CUP_hgun_Deagle"
#define PISTOL3_MAG "CUP_7Rnd_50AE_Deagle:3"
// Grenades
...
#define BASE_GRENADES MOLOTOV,SIDE_SMOKE
// Gear
...
#define SHOTGUN "ptv_bm4"
#define SHOTGUN_MAG "ptv_8Rnd_B_Beneli_74Pellets:10","ptv_8Rnd_B_Beneli_74Slug:5"
...
class ftl: rifleman {// FTL
  ...
  weapons[] = {GLRIFLE};
  handguns[] = {PISTOL2};
  magazines[] = {GLRIFLE_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,PISTOL2_MAG,LEADER_GRENADES};
...
class sl: ftl {// SL
  ...
  handguns[] = {PISTOL3};
  magazines[] = {RIFLE_MAG,PISTOL3_MAG,BASE_GRENADES};
...
class ar: rifleman {// AR
  ...
  weapons[] = {AR};
  magazines[] = {AR_MAG,PISTOL2_MAG,BASE_GRENADES};
  handguns[] = {PISTOL2};
  handgunAttachments[] = {PISTOL_OPTIC};
};
...
class mmgg: ar {// MMG
  weapons[] = {MMG};
  magazines[] = {MMG_MAG,PISTOL2_MAG,BASE_GRENADES};
...
class fac: coy {// FAC
  magazines[] = {GLRIFLE_MAG,SIDE_FAC_GRENADES,"Laserbatteries",PISTOL3_MAG};
...
class plm: sm {//Platoon Medic
  ...
  magazines[] = {RIFLE_MAG_REDUCED,PISTOL2_MAG,MEDIC_GRENADES};
};
...
class hmgl: sl {// HMG Lead
  weapons[] = {RIFLE};
  magazines[] = {RIFLE_MAG,LEADER_GRENADES,PISTOL3_MAG,HMG_MAG};
  backpack[] = {CARRYALL};
...
class hatl: sl {// HAT Lead
  weapons[] = {RIFLE};
  backpackItems[] = {};
  magazines[] = {RIFLE_MAG,LEADER_GRENADES,PISTOL3_MAG,HAT_MAG};
  backpack[] = {CARRYALL};
  launchers[] = {HAT_TRI};
  items[] += {BASE_MEDICAL};
};
