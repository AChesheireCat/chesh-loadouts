...
description = "GSG-9 Counter-Terrorism unit c. 1980-1990s. Based upon the CS:S interpretation. Requires GlobMob CDLC. (Last Updated: 2025/04/20)";
...
// Camo set
#define CAMO_UNIFORM "gm_ge_uniform_pilot_commando_oli","gm_ge_uniform_pilot_commando_rolled_oli"
#define CAMO_VEST "gm_ge_vest_sov_armor_80_blk"
#define CAMO_BACKPACK "B_Battle_Belt_F"
#define CARRYALL "B_Battle_Belt_XL_F"
#define CAMO_HEADGEAR "gm_ge_bgs_headgear_psh77_cover_smp"
#define CAMO_HEADGEAR_SPECIAL 
// Pilot Camo set
#define CAMO_UNIFORM_PILOT CAMO_UNIFORM
#define CAMO_VEST_PILOT "gm_ge_army_vest_pilot_pads_oli"
...
#define CAMO_VEST_VICC "gm_ge_army_vest_pilot_oli"
#define CAMO_BACKPACK_VICC CARRYALL
#define CAMO_HEADGEAR_VICC "gm_ge_headgear_beret_crew_blk_armor"
// Rifle
...
#define SNIPER_MAG "hlc_20rnd_762x51_T_G3:10"
...
#define PISTOL_MAG "CUP_12Rnd_45ACP_mk23:4"
#define PISTOL_ATTACHMENTS "CUP_acc_mk23_lam_f","CUP_muzzle_snds_mk23"
// Grenades
#define LEADER_GRENADES SIDE_FRAG,LEADER_SMOKES,SIDE_CHEM_LIGHT
#define SIDE_FRAG "ACE_M84:4"
#define SIDE_SMOKE "SmokeShell:2"
#define LOADOUT_GRENADES SIDE_FRAG,SIDE_SMOKE,SIDE_CHEM_LIGHT
// Gear
...
#define CAMO_BACKPACK_MEDIC "cwr3_b_backpack_m5_medic"
...
class rifleman {// rifleman
  ...
  weapons[] = {RIFLE};
  handguns[] = {PISTOL};
  magazines[] = {RIFLE_MAG,PISTOL_MAG,LOADOUT_GRENADES};
  items[] = {TOOLS};
  linkedItems[] = {LINKED};
...
class Fic_Soldier_Carbine: rifleman {// carbine-man
  weapons[] = {CARBINE};
  magazines[] = {CARBINE_MAG,PISTOL_MAG,LOADOUT_GRENADES};
};
...
class spotter: Fic_Spotter {// Spotter
  ...
  vest[] = {"gm_ge_bgs_vest_type3_gry"};
  weapons[] = {SPOTTER};
  handguns[] = {PISTOL};
  backpack[] = {CARRYALL};
  magazines[] = {SPOTTER_MAG,SNIPER_MAG,PISTOL_MAG,LOADOUT_GRENADES};
