...
description = "British Armed Forces c. 1986 when the first introduced the SA80 line of small arms. Includes fully configured SF section, representing an SAS unit during the Falklands War.";
...
#define CAMO_HEADGEAR "CUP_H_BAF_PARA_BERET"
...
#define AR_MAG "30Rnd_556x45_Stanag_red:10","30Rnd_556x45_Stanag_Tracer_Red:5"
// AT
...
// Spotter
#define SPOTTER "CUP_arifle_M4A1"
