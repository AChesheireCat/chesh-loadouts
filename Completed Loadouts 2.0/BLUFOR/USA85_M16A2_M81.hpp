...
description = "US Army c.1985 - MAT is the ACE M47 Dragon. SF section fully configured as Army SF (Green Berets). Uses S.O.G Prarie Fire assets. (Last Updated: 2025/05/23)";
...
// Camo set
#define CAMO_UNIFORM "cwr3_b_uniform_m81_woodland","cwr3_b_uniform_m81_woodland","cwr3_b_uniform_m81_woodland_gloves","cwr3_b_uniform_m81_woodland_rolled","cwr3_b_uniform_m65_woodland","cwr3_b_uniform_m65_woodland_gloves","cwr3_b_uniform_m65_woodland_rolled","cwr3_b_uniform_m65_woodland_rolled","cwr3_b_uniform_m65_woodland_rolled_gloves"
#define CAMO_VEST "cwr3_b_vest_alice","cwr3_b_vest_alice","cwr3_b_vest_alice_ar"
#define CAMO_BACKPACK "B_Battle_Belt_F"
#define CARRYALL "cwr3_b_backpack_alice"
#define CAMO_HEADGEAR "cwr3_b_headgear_pasgt_m81_woodland","cwr3_b_headgear_pasgt_m81_woodland","cwr3_b_headgear_pasgt_m81_woodland","cwr3_b_headgear_pasgt_m81_woodland_goggles"
...
#define GLRIFLE_MAG_FLARE "UGL_FlareGreen_F:2"
...
#define CAMO_VEST_MEDIC "cwr3_b_vest_alice_light"
...
#define CAMO_BACKPACK_FAC "cwr3_b_backpack_radio"
...
class sm: Fic_Soldier_Carbine {// Medic
  ...
  backpackItems[] = {MEDIC_MEDICAL,HEADLAMP};
};
...
class spotter: Fic_Spotter {// Spotter
  ...
  weapons[] = {SPOTTER};
  magazines[] = {SPOTTER_MAG,SNIPER_MAG,SIDE_BASE_GRENADES,"Laserbatteries"};
...
class sniper: spotter {// Sniper
  ...
  backpack[] = {"ace_gunbag"};
  weapons[] = {SNIPER};
  magazines[] = {SMG_MAG,SNIPER_MAG,SIDE_BASE_GRENADES};
...
class fac: coy {// FAC - mission repurposed to FO
  weapons[] = {CARBINE};
  backpack[] = {CAMO_BACKPACK_FAC};
  magazines[] = {RIFLE_MAG,SIDE_FAC_GRENADES,PISTOL_MAG};
...
class rifleman_03: rifleman_02 {// Rifleman 3
};
class rifleman_04: rifleman_02 {// Rifleman 4
};
...
class sf_rifleman {// sf rifleman
  ...
  weapons[] = {SF_RIFLE};
  handguns[] = {"Knife_m3"};
  magazines[] = {SF_RIFLE_MAG,SIDE_BASE_GRENADES,SIDE_CHEM_LIGHT,SIDE_CHEM_LIGHT};
  items[] = {TOOLS};
  linkedItems[] = {LINKED};
...
class sf_rifleman_02: sf_rifleman {// sf rifleman 02
  ...
  magazines[] = {"CUP_30Rnd_9x19_MP5:5",SF_SNIPER_MAG,SF_PISTOL_MAG,SIDE_BASE_GRENADES,SIDE_CHEM_LIGHT,SIDE_CHEM_LIGHT};
  items[] = {TOOLS,"ACE_RangeCard","ACE_Tripod"};
  linkedItems[] = {LINKED,BINOS};
};
class sf_ar: sf_rifleman {// AR
  vest[] = {SF_VEST_AR};
  weapons[] = {SF_AR};
  magazines[] = {SF_AR_MAG,SF_PISTOL_MAG,SIDE_BASE_GRENADES,SIDE_CHEM_LIGHT,SIDE_CHEM_LIGHT};
  handguns[] = {SF_PISTOL};
...
class sf_aar: sf_rifleman {// AAR
  weapons[] = {SF_CARBINE};
  magazines[] = {SF_CARBINE_MAG,SIDE_BASE_GRENADES,SIDE_CHEM_LIGHT,SIDE_CHEM_LIGHT};
...
class sf_lat: sf_rifleman {// RAT
  backpack[] = {SF_BACKPACK};
  weapons[] = {SF_CARBINE};
  magazines[] = {SF_CARBINE_MAG,SF_AT_MAG,SIDE_BASE_GRENADES,SIDE_CHEM_LIGHT,SIDE_CHEM_LIGHT};
  launchers[] = {SF_AT};
