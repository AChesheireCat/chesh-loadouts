...
description = "United States Army c.1950 - No GPS, no MicroDAGR, reduced radios";
...
#define CAMO_VEST "vn_b_vest_usarmy_02"
...
#define GLRIFLE_MAG_HE "vn_22mm_m1a2_frag_mag:2"
#define GLRIFLE_MAG_FLARE "vn_22mm_lume_mag:4"
#define GLRIFLE_MAG_AT "vn_22mm_m9_heat_mag:3"
// Carbine
#define CARBINE "vn_m1carbine"
#define CARBINE_MAG "vn_carbine_15_mag:10"
// AR
#define AR "vn_m1918"
#define AR_MAG "vn_m1918_mag:10","vn_m1918_t_mag:5"
...
// HAT - Use AT Gun as applicable
#define HAT 
#define HAT_TRI_HI 
#define HAT_TRI_LO 
#define HAT_MAG 
// SAM - Use AAA as applicable
#define SAM 
#define SAM_MAG 
// Sniper
#define SNIPER "vn_m1903"
#define SNIPER_MAG "vn_m1903_mag:10"
...
#define WILLYPETE "vn_m34_grenade_mag:2"
#define FLARE "ACE_HandFlare_Green:2"
#define BASE_GRENADES SIDE_FRAG,SIDE_SMOKE
// Gear
#define TOOLS OLD_TOOLS
...
#define CAMO_VEST_FTL "vn_b_vest_usarmy_05"
...
#define CAMO_BACKPACK_MMG "vn_b_pack_lw_02"
#define CAMO_BACKPACK_MMG2 "vn_b_pack_lw_05"
...
class ftl: rifleman {// FTL
  ...
  weapons[] = {GLRIFLE};
  magazines[] = {GLRIFLE_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_AT,GLRIFLE_MAG_SMOKE,LEADER_GRENADES};
...
class lat: rifleman {// RAT
  ...
  magazines[] = {GLRIFLE_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_AT,};
};
...
class mtrg: Fic_Soldier_Carbine {// Mortar Gunner
  ...
  magazines[] += {"ace_compat_sog_60mm_he:6","ace_compat_sog_60mm_lume:2"};
};
class mtrag: Fic_Spotter {// Assistant Mortar
  launchers[] = {"ace_csw_carryMortarBaseplate"};
  MORTAR_GEAR(CARRYALL)
  magazines[] += {"ace_compat_sog_60mm_he:2","ace_compat_sog_60mm_wp:4","ace_compat_sog_60mm_lume:2"};
};
