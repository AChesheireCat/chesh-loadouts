...
description = "German Heimatschutz (Home Defense Reservists) c. 2020 - REQ GlobMob CDLC (Last Updated: 2025/06/15)";
...
// Camo set
#define CAMO_UNIFORM "CUP_U_B_GER_Flecktarn_5","CUP_U_B_GER_Flecktarn_8","CUP_U_B_GER_Flecktarn_6","CUP_U_B_GER_Flecktarn_7"
#define CAMO_VEST "gm_ge_vest_90_rifleman_flk"
#define CAMO_BACKPACK "B_Battle_Belt_F"
#define CARRYALL "gm_ge_army_backpack_90_flk"
#define CAMO_HEADGEAR "gm_ge_headgear_hat_90_flk"
...
//Custom Defines
#define CAMO_VEST_AR "gm_ge_vest_90_machinegunner_flk"
#define CAMO_VEST_FTL "gm_ge_vest_90_leader_flk"
#define CAMO_VEST_SL CAMO_VEST_FTL
#define CAMO_VEST_MEDIC "gm_ge_vest_90_medic_flk"
...
class ftl: rifleman {// FTL
  ...
  weapons[] = {GLRIFLE};
  magazines[] = {GLRIFLE_MAG,GLRIFLE_MAG_HEDP,GLRIFLE_MAG_SMOKE,LEADER_GRENADES};
  items[] += {LEADER_TOOLS};
