...
// Camo set
#define CAMO_UNIFORM "U_tweed_acu_summer_ocp_tuck","U_tweed_acu_summer_ocp_tuck_jedi","U_tweed_acu_summer_ocp_tuck_trop","U_tweed_acu_summer_ocp","U_tweed_acu_summer_ocp_jedi","U_tweed_acu_summer_ocp_trop","U_tweed_acu_summer_ocp_crye","U_tweed_acu_summer_ocp_crye_trop","U_tweed_acu_summer_ocp_crye_knee","U_tweed_acu_summer_ocp_crye_knee_trop"
