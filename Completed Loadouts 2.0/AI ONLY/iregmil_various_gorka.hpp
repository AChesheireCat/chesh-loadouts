...
#define CAMO_VEST "CUP_V_B_GER_Carrier_Rig_3_Brown", "CUP_V_RUS_Smersh_New_Full", "rhs_6sh92_vsr_radio"
...
#define ALT_OPTICS 
// Rifle 2
#define RIFLE2 "cwr3_arifle_fnfal_hlag"
...
// Rifle 4
#define RIFLE4 "CUP_arifle_AKM_Early","CUP_arifle_AKMS_Early","CUP_arifle_TYPE_56_2_Early","CUP_arifle_AK47_Early","CUP_arifle_RPK74"
#define RIFLE4_MAG "CUP_30Rnd_762x39_AK47_M:7","CUP_30Rnd_TE1_Yellow_Tracer_762x39_AK47_M:3"
// GL Rifle
...
#define CAMO_VEST_FTL "rhs_6sh92_vsr_vog_headset", "CUP_V_B_GER_Carrier_Rig_3_Brown", "CUP_V_RUS_Smersh_New_Full"
...
class rifleman {// rifleman
  ...
  weapons[] = {RIFLE4};
  magazines[] = {RIFLE4_MAG,BASE_GRENADES};
  items[] = {TOOLS};
  linkedItems[] = {LINKED};
...
class ftl: rifleman {// FTL
  ...
  weapons[] = {RIFLE2};
  magazines[] = {RIFLE2_MAG,LEADER_GRENADES};
...
class sl: ftl {// SL
  ...
  weapons[] = {GLRIFLE3};
  magazines[] = {GLRIFLE3_MAG,GLRIFLE2_MAG_HE,GLRIFLE2_MAG_SMOKE,GLRIFLE3_MAG_FLARE,LEADER_GRENADES,PISTOL_MAG};
  handguns[] = {PISTOL};
...
class lat: rifleman {// RAT
  vest[] = {"CUP_V_B_GER_Carrier_Rig_3_Brown", "CUP_V_RUS_Smersh_New_Radio", "rhs_6sh92_vsr_radio"};
