...
description = "Czechoslovakian People's Army 'Motostřelci' c. 1978 - REQs GlobMob and S.O.G CDLC (Last Updated: 2025/06/27)";
...
// Camo set
#define CAMO_UNIFORM "potato_jehlici"
...
#define CAMO_HEADGEAR_SPECIAL "gm_ge_headgear_winterhat_80_oli"
// Pilot Camo set
...
#define CAMO_VEST_SNIPER "cwr3_o_vest_harness_svd"
#define CAMO_VEST_ENG "cwr3_o_vest_harness_sapper"
...
reinforcementTruck = "gm_pl_army_ural4320_cargo";
reinforcementArmed = "gm_pl_army_ot64a";
// ------------- End Vehicle Pool -------------
