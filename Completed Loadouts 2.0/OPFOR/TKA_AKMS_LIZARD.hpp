...
description = "Takistani Army c. 2010 - requires S.O.G CDLC (Last Updated 2025/02/09)";
...
// Camo set
#define CAMO_UNIFORM "CUP_U_O_TK_MixedCamo"
#define CAMO_VEST "CUP_V_O_TK_Vest_1"
...
// Rifle
#define RIFLE "CUP_arifle_AKMS_Early","CUP_arifle_AKS","CUP_arifle_TYPE_56_2_Early"
#define RIFLE_MAG "CUP_30Rnd_762x39_AK47_TK_M:7", "CUP_30Rnd_TE1_Green_Tracer_762x39_AK47_M:3"
...
#define PISTOL_OPTIC 
// Grenades
#define SIDE_LEADER_GRENADES LOADOUT_FRAG,LEADER_SMOKES,SIDE_CHEM_LIGHT
...
reinforcementTruck = "CUP_O_Ural_TKA"
reinforcementArmed = "gmx_tak_army_m113a1g_apc_des"
// ------------- End Vehicle Pool -------------
...
class ftl: rifleman {// FTL
  ...
  weapons[] = {GLRIFLE};
  magazines[] = {GLRIFLE_MAG,GLRIFLE_MAG_HE,GLRIFLE_MAG_SMOKE,SIDE_SIDE_LEADER_GRENADES};
  items[] += {LEADER_TOOLS};
